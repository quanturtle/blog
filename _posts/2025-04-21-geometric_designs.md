...
![]({{ site.baseurl }}/img/geometric_designs/geometric_designs_01.jpg)
...
[![Video Title](https:/{{ site.baseurl }}/img.youtube.com/vi/JWhNcsYoXQ0/0.jpg)](https://www.youtube.com/watch?v=JWhNcsYoXQ0)

His designs, scanned from an original edition, have that distinctive hue of yellow that you get from an old book.

![]({{ site.baseurl }}/img/geometric_designs/geometric_designs_02.jpg)

![]({{ site.baseurl }}/img/geometric_designs/geometric_designs_03.jpg)

![]({{ site.baseurl }}/img/geometric_designs/geometric_designs_04.jpg)

![]({{ site.baseurl }}/img/geometric_designs/geometric_designs_05.jpg)

![]({{ site.baseurl }}/img/geometric_designs/geometric_designs_06.jpg)

![]({{ site.baseurl }}/img/geometric_designs/geometric_designs_07.jpg)

## How can I recreate these designs?
The book provides clear instructions on how to set up everything we need to draw:

![]({{ site.baseurl }}/img/geometric_designs/geometric_designs_08.jpg)

![]({{ site.baseurl }}/img/geometric_designs/geometric_designs_09.jpg)

![]({{ site.baseurl }}/img/geometric_designs/geometric_designs_10.jpg)
...
![]({{ site.baseurl }}/img/geometric_designs/geometric_designs_11.jpg)
...
![]({{ site.baseurl }}/img/geometric_designs/geometric_designs_12.jpg)

![]({{ site.baseurl }}/img/geometric_designs/geometric_designs_15.jpg)

![]({{ site.baseurl }}/img/geometric_designs/geometric_designs_16.jpg)
...
![]({{ site.baseurl }}/img/geometric_designs/geometric_designs_13.jpg)

![]({{ site.baseurl }}/img/geometric_designs/geometric_designs_14.jpg)
